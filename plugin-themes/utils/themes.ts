...
import { getThemeVarsPlugin } from '../plugins/postcss/get-theme-vars-plugin';
...
// 主题数据缓存文件绝对路径 ${project}/node_modules/.cache/themes_data.json
const cacheUrl = path.resolve('node_modules', CACHE_PATH);
